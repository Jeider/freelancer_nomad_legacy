...
Если вы накатываете мод на фрил, то в русской версии вам нужно удалить AUDIO/nnvoice.utf и AUDIO/mc_leg_m01.utf, чтобы правильно прогрузить русскую версию соответствующего аудио.
