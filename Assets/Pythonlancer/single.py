...
def draw_base_for_hardpoints():
    ...
    base_class = scient.ScientRootComponents
    # new_name = 'or_hq_vienna_entry'
    the_base = base_class()
...
#     1: 'Прогружаю отчёт Дом Кавашей. Константы конвертированы в земные. '
#        '«Мы доб+ыли вещество из кор+ы звезды. Предел прочности — 10 миллиардов циклов давления в ядре Кел-Т+ариса. '
#        'Стабильность требует поле в сто миллиардов глоссов — как у пробудившегося магнетара. '
#        'Это не материал — это замороженное пространство-время. '
#        'Мы называем его "Семя Творения"».',
#
#     2: 'Прогружаю отчёт Дом Кавашей. Константы конвертированы в земные. '
#        '«Кварки заперты в нуклонах навечно — если не применить энергию звезды. '
#        'Мы высвободили "цветной заряд". '
#        'Оружие превращает вражескую материю в странную кварковую кашу, локально меняя законы физики».',
#
#     3: 'Прогружаю отчёт Дом Кавашей. Константы конвертированы в земные. '
#        '«Гравитация звезды изгибает свет в кольцо. '
#        'Это природный телескоп в прошлое. Мы научились читать "эхо вероятностей" — свет событий, '
#        'которые могли бы случиться, но не случились. Это не пророчество. Это картография упущенных реальностей».',

    4: 'Прогружаю отчёт Дом Кавашей. Константы конвертированы в земные. '
       '«99 процентов энергии коллапса уносят нейтрино — частицы-призраки, проходящие сквозь материю. '
       'Мы созд+али коммуникационную сеть на нейтринном сопряжении: сигнал приходит мгновенно в любую точку все-ленной. '
       'Теперь мы передаём через неё не только данные, но и энергию. Щиты бесполезны перед нейтринным лучом».',
    #
    # 5: 'Прогружаю отчёт Дом Кавашей. Константы конвертированы в земные. '
    #    '«Нейтронная звезда — не труп. Это компьютер, считающий фундаментальные константы. '
    #    'Мы объединили всё: ядерную пасту как корпус, странную материю как процессор, нейтрино как шину. '
    #    'Омега-Адаптер нарушает закон сохранения массы/энергии. Мы покидаем этот цикл реальности. '
    #    'Оставляем ключ тому, кто поймёт: важнее материи — её потенциал».',
}
