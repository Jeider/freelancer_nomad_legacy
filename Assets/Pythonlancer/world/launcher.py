...
class Launcher(Equipment, MainEquipPrice, LauncherGood):
    ...
    AMMO_ICON_PER_WEAPON_MODEL = {
        ...
        GE_TORPEDO: Icon.ICON_GE_MISSILE,
...
seeker_fov_deg = {self.SEEKER_FOV}
...
class MainMissile(Missile):
    ...
    RU_KIND = 'Ракета'
    RU_BASE_INFO = 'Сбалансированная ракета с умеренной скоростью и с эффективной мощностью'
    MAX_PRICE = 120000
    MAX_AMMO_PRICE = 6000
...
class CruiseDisruptor(Missile):
    ...
    MOTOR_LIFETIME = 0.892500
    MOTOR_ACCEL = 523.085083
    ...
    RU_NAME_PER_FACTION = {
        Equipment.FACTION_RH: 'Нейтрализатор',
        Equipment.FACTION_LI: 'Хорнет',
        Equipment.FACTION_BR: 'Фальконет',
        Equipment.FACTION_KU: 'Рогатка',
        Equipment.FACTION_CO: 'Оса',
    }
