...
RU_FEATURES_PER_FACTION = {
    MainMiscEquip.FACTION_RH: 'Рейнландская броня умеренно эффектвно упрочнает корпус и занимает не так много места в трюме',
    MainMiscEquip.FACTION_LI: 'Броня Либерти сбалансированно упрочняет корпус корабля за счет места в трюме',
    MainMiscEquip.FACTION_BR: 'Бретонская броня имеет отличную прочность за счет большего занимаего объема трюма',
