...
class Msn12CapturedScene(Scene):
    ...
    def action(self):
        ...
        trent = Character(root=self, actor=actors.Trent, light_group=0, init_point='char1')
        edison = Character(root=self, actor=actors.EdisonTrent, light_group=0, init_point='char2')

        bartender_fixture = Character(root=self, actor=actors.BartenderFixture, light_group=0, init_point=self.DEFAULT_POINT_NAME, rotate_y=0)
