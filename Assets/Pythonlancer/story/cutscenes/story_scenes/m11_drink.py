...
class Msn11DrinkScene(Scene):
    ...
    def action(self):
        ...
        edison.motion(group=MAIN, duration=12, anim=Male.Sc_MLBODY_STND_IDLE_000LV_xa_04, time_scale=1)
        ...
        drinkins_time_mov1 = cam_drinkins.move_cam(group=MAIN, index=2, duration=14, smooth=True)
