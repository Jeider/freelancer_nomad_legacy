...
class Msn3Offer(Msn3, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(40, Trent, ru="И в чем же будет состоять эта миссия?", en="And what will we do on this mission?"),
        VoiceLine(50, Wilham, ru="Да как обычно. Летаем, стреляем, ничего нового.", en="The usual thing. Fly, shoot, nothing new."),
        ...
        VoiceLine(80, Trent, ru="То есть те, кто будет таскать вам каштаны из огня.", en="You mean, those will be the guys who drag fire away from your asses."),
        ...
        VoiceLine(140, Wilham, ru=": Вы умный человек, герр Трент. ", en="You're a wise man, Herr Trent. "),
...
class Msn3Reward(Msn3, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, Hassler, ru="Мне тоже... Деньги уже на твоем счету. До скорого.", en="Me neither... The money's been transferred to your account. See you later."),
    ]
