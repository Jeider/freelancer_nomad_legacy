...
class Msn12Space(Msn12, script.SpaceVoiceProps):
    VOICE_LINES = [
        ...
        VoiceLine(320, Kruger, ru='Вражеские инжерные войска приступили к демонтажу минных заграждений'),
        VoiceLine(330, Hatcher, ru='Чёрт! Серьезной взялись. Держитесь! Мы уже не подходе'),
        ...
        VoiceLine(500, Hatcher, comment='Этап 3. Инженеры',
                  ru='Форт Аламо, мы находимся в вашем секторе. Ваш статус?'),
        ...
        VoiceLine(520, Hatcher, ru='Принято, Аламо'),
        ...
        VoiceLine(600, Hatcher, ru='Рудокопы выведены из строя. Аламо, статус?'),
        ...
        VoiceLine(630, King, ru='Всем силам приказ вернуться внутрь защитного периметра. Код 1138. Штаб находится под угрозой'),

        VoiceLine(700, FortBush, comment='Этап 4. бывш. форт Буш', ru='Внимание! Всеобщая эвакуация! Всем...хрррхррр'),
        VoiceLine(710, Darcy, comment='Форт Буш взрывается нафиг', ru='Остались от Буша только ножки...'),
        ...
        VoiceLine(810, King, ru='Я прикрываю Энтерпайз на Осирисе. Мы в вашем секторе.'),
        VoiceLine(820, Hatcher, ru='Ты не рискуешь?'),
        VoiceLine(830, King, ru='У нас нет другого выбора...'),

        VoiceLine(850, Hatcher, ru='Есть! Линкоры остановлены!'),
        VoiceLine(860, Omaha, ru='Говорит крейсер Омаха. Мы прибыли вам на помощь'),
