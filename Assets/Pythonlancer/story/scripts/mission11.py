...
class Msn11AmbushCutscene(Msn11, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(
            140,
            Rockford,
            comment='Рокфорд мотивирует свои действия отсылками к режиссерскому интро фрилансера, '
                    'где Номады выплили всех людей в солнечной системе',
...
class Msn11FinalCutscene(Msn11, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(180, EdisonTrent, ru='Если коротко - то все плохо. Рокфорд, как ты понял, решил "спасти" все человечество. И сейчас ни СБА, ни Орден помешать ему уже не могут.'),
        VoiceLine(190, EdisonTrent, ru='А вот у тебя, учитывая твою патологическую везучесть, может и получиться.'),

        VoiceLine(200, Trent, ru='А кто такой вообще этот Рокфорд?'),

        VoiceLine(210, EdisonTrent, ru='Один очень хороший человек, внезапно слетевший с катушек и задавшийся целью осчастливить человечество.'),
        VoiceLine(220, EdisonTrent, ru='Проблема в том, что в этом случае, обычные клерки приносят в патентные бюро чертежи вечных двигателей, а вот фигуры масштаба Рокфорда могут и уничтожить человечество в процессе спасения.'),

        VoiceLine(230, Trent, ru='А поконкретнее?'),

        VoiceLine(240, EdisonTrent, ru='Аттикус Рокфорд... великий и ужасный. Он - из ветеранов Ордена.'),
        VoiceLine(250, EdisonTrent, ru='Очень болезненно отнесся к тому что Орден не смог предотвратить экспансию кочевников во время того инцедента и занялся изучением артефактов - так называемого наследия кочевников.'),
        VoiceLine(260, EdisonTrent, ru='Именно он обнаружил ту самую сферу, и каким-то образом понял что она - своего рода ящик Пандоры, и содержит в себе смертоносную силу.'),
        VoiceLine(270, EdisonTrent, ru='Мы вместе работали над сферой. Он нашел способ ее уничтожить, но руководство Ордена было категорически против.'),
        VoiceLine(280, EdisonTrent, ru='Тогда уже начала проявляться его маниакальность в достижении цели, а я понял, что ключ номадов сможет управлять сферой.'),
        VoiceLine(290, EdisonTrent, ru='И решил удалиться подальше. Так что мое пленение ксеносами было мною подстроено.'),

        VoiceLine(300, Trent, ru='Рокфорд как-то в беседе обмолвился, что видел смерть миллиардов человек. О чем он?'),
        VoiceLine(310, EdisonTrent, ru='О Солнечной Системе. Не забивай себе голову, забудь.'),
        VoiceLine(320, Trent, ru='Так сколько ему лет? Он был на корабле спящих?'),
        VoiceLine(330, EdisonTrent, ru='Не о том думаешь, тезка. Не это сейчас главное.'),
        VoiceLine(340, Trent, ru='Сейчас главное то - что ключ номадов у Рокфорда и он сможет сделать со сферой все что захочет, и никто не сможет ему помешать.'),

        VoiceLine(350, EdisonTrent, ru='Не совсем так. (достает еще один ключ) В добровольное изгнание к ксенос я отправился не с пустыми руками. Он абсолютно идентичен тому, который сейчас у Рокфорда.'),
        VoiceLine(360, Trent, ru='И что мне с ним делать?'),
        VoiceLine(370, EdisonTrent, ru='Решать тебе, но я бы в лучшие свои годы собрал силы, Ордена или СБА и полетел бы прямо к сфере, пытаясь остановить Рокфорда, пока это еще возможно.'),
        VoiceLine(380, Trent, ru='И почему же вместо того чтобы это сделать, ты сидишь и разговариваешь со мной в баре?'),

        VoiceLine(390, EdisonTrent, ru='Потому что много лет назад мы сильно разошлись во мнениях с моим бывшим другом и нынешним руководителем СБА, Кингом.'),
        VoiceLine(400, EdisonTrent, ru='Как раз после того, как я нашел место крушения Испании и... Аттикуса.'),
        VoiceLine(410, EdisonTrent, ru='Тогда я сильно расстроился, и даже продал свой корабль, надеясь затеряться на узких улочках одной из планет Кусари, но, видимо, не судьба.'),
        VoiceLine(420, EdisonTrent, ru='А Ямамото... Черт бы побрал этих самураев. Сейчас он занят истреблением врагов и ему плевать на всё.'),
        VoiceLine(430, EdisonTrent, ru='Даже если этот мир исчезнет во взрыве сверхновой, но с этим взрывом погибнет последний его враг, он будет доволен.'),
...
class Msn11Space(Msn11, script.SpaceVoiceProps):
    VOICE_LINES = [
        ...
        VoiceLine(
            80,
            Yamamoto,
            ru='Станция "Миллениум" атакована силами Рейнланда! Всем немедленно выдвинуться на защиту!'
        ),
        VoiceLine(
            90,
            Kim,
        ...
        VoiceLine(
            120,
            Kim,
            comment='Выдвигаемся к станции Миллениум',
        ...
        VoiceLine(
            310,
            Kim,
            ru='Нужна передышка. Летим на планету Хонсю. Я покажу гипердыру.'
        ),
        VoiceLine(
            320,
            Trent,
        ...
        VoiceLine(
            330,
            Trent,
            ru='(Охеревающий) А "Миллениум". Почему она так плохо охранялась? Где линкоры, тучи истребителей?.. Ким, ты можешь мне ответить?!!'
        ),
        VoiceLine(
            340,
            Kim,
        ...
        VoiceLine(
            350,
            Kim,
            comment='Орбита Хонсю',
            ru='Мистер Трент, вы можете пока отдохнуть... Будьте на связи, вы можете вскоре нам понадобиться.'
        ),
    ]
