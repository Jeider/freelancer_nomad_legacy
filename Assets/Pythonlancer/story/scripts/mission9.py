...
class Msn9RewardCutscene(Msn9, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(
            110,
            Hassler,
            ru='Нет, герр Трент. Но целеустремленность этих людей воодушевляет'
        ),
        VoiceLine(
            120,
            Trent,
        ...
        VoiceLine(
            130,
            Hassler,
            ru='Пока нужно отдохнуть. Для вас и фрау Дерси выделены индивидуальные каюту на линкоре, вас проводят'
        ),
    ]
