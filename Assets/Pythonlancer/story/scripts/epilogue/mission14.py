...
class TrentRescuedCutscene(Msn14, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(125, EdisonTrent, ru='Ты же помнишь про Альянс, который воевал с Коалицией. Альянс когда-то разослал огромное количество исследовательских кораблей. Чтобы найти новый дом. Так Альянс, кстати, и нашел сектор Сириуса и все потенциально обитаемые планеты.'),
