...
class JackMeetScene(MsnRobigo, script.CutsceneProps):
    ...
    DESCRIPTION = ''
    VOICE_LINES = [
        VoiceLine(10, Trent, ru='Эй, с крюком. Это ты Джек Брадобрей?'),
        VoiceLine(20, JackRazorBarber, ru='Прикус+и яз+ык, висельный прихвостень! Перед тобой сам капитан Джек Брадобр+еей! '),
        ...
        VoiceLine(100, Trent, ru='Я просто в+ыздоровел! Так, давай на чистоту. У меня задание от мисс Зейн. Мне нужн+ы ты, твоя команда и твой пиратский корабль.'),
        ...
        VoiceLine(160, JackRazorBarber, ru='Да юнга, дело говоришь. Если не разорвут живьем эти шакалы, то набегут другие. И этих других я в одиночку своей шпагой не заколю.'),
        VoiceLine(170, JackRazorBarber, ru='Готовь парус+а, юнга. Мы вых+одим в море. Насколько вместительно брюхо твоего корвета?'),
