...
class Msn13Space(Msn13, script.SpaceVoiceProps):
    VOICE_LINES = [
        ...
        #
        # "Блин, заряда установки хватило чтобы шибануть по Крыгу!"
        ...
        #
        # "Мы потеряли Омаху нахер!",
        # "Крыг еще слаб. Мы можем нейтрализовать его, пока он еще не вошел в силу. Мистер Трент, вы должны уничтожить генераторы на корпусе Крыга"
        # "Вы там совсем башкой поехали с такими идеями?"
        # "Если мы это не сделаем, то Крыг зарядится и перебьет нас как куропаток. Скорее, времени мало!",
        #
