...
class Msn13BattleshipFirstCutscene(Msn13, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, Trent, ru='Эта вундервафля запрограммирована на уничтожение кочевников.'),
        VoiceLine(40, Trent, ru='Если я смогу подключить все эти энергоячейки к реактору своего корабля, для Крыга они засветятся как первичная цель.'),
        VoiceLine(50, Trent, ru='Затем я отстрелю реактор в черную дыру, и он полетит за ним как мотылек на огонек, ничего не сможет с собой поделать.'),
        VoiceLine(60, Trent, ru='Только обеспечьте мне несколько спокойных минут, чтобы вся эта мошкара не надоедала.'),
...
class Msn13SuccessCutscene(Msn13, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(90, Trent, ru='Нееет, это вредно для моей формы.'),
        VoiceLine(100, Trent, ru='Что, теперь будешь отдыхать от приключений?'),
        VoiceLine(110, Trent, ru='Я? Неет, в крайних мирах еще много чего неизвестного. Возможно, там на краю и свидимся, мистер Трент!'),
...
class Msn13Space(Msn13, script.SpaceVoiceProps):
    VOICE_LINES = [
        VoiceLine(10, Trent, ru='Профессор, что удалось узнать из данных полученных от Рокфорда?'),
        VoiceLine(20, Mandrake, ru='Да, удалось. И все достаточно серьёзно. В сфере заточён Крыг.'),
        VoiceLine(30, Alaric, ru='Круг? В сфере?'),
        VoiceLine(40, Darcy, ru='Аларик, не время.'),
        VoiceLine(50, Mandrake, ru='Крыгом я для простоты называю корабль расы Крыг, '
                               'чтобы не выдумывать спаециально название, не плодить сущности.'),

        VoiceLine(60, Hatcher, ru='Еще одна раса?'),
        VoiceLine(70, Mandrake, ru='Древнейший естественный враг кочевников. Когда-то давно кочевники практически уничтожили Крыгов.'),
        VoiceLine(80, Mandrake, ru='И тогда Крыги создали оружие, способное уничтожить всю расу кочевников, '
                                  'но не применяли до самого конца, так как оно могло навредить им самим.'),
        VoiceLine(90, Mandrake, ru='В общем, история древняя как мир. И, как всегда в таких случаях бывает, когда терять им стало нечего, они его таки применили.'),
        ...
        VoiceLine(200, Rockford, ru='Остановитесь, глупцы, что вы делаете? Я уничтожу эту заразу раз и навсегда!'),
        ...
        VoiceLine(460, King, ru='Этой твари весь наш флот на один зубок! Нужно срочно что-то делать!'),
