...
class Msn13Space(Msn13, script.SpaceVoiceProps):
    VOICE_LINES = [
        ...
        VoiceLine(1190, Trent, "Фух, вылетели"),
        VoiceLine(1200, EdisonTrent, "Да, нам повезло..."),
        VoiceLine(1210, EdisonTrent, "Осирис, это Альфа. У нас неприятности, Крыг перестроил зёрна. Теперь они чрезвычайно опасны"),
        VoiceLine(1220, King, "Вас понял, Альфа. Меняем план. Мы смогли отвлечь часть номадских сил с первого маршрута"),
        VoiceLine(1230, King, "Вы сможете прошмыгнуть. Направляйтесь туда"),
        VoiceLine(1230, EdisonTrent, "Так точно, Осирис. Мы летим"),

        VoiceLine(1240, EdisonTrent, "Тёзка, давай пролетим через эти большие астероиды. Сканеры не видят в них никакой активности"),
        VoiceLine(1250, Trent, "Понял, принял"),

        VoiceLine(1260, EdisonTrent, "Вроде всё спокойно"),

        VoiceLine(1270, Trent, "Чёрт, зерно!"),

        VoiceLine(1280, Trent, "Эй, что это за истребители?"),
        VoiceLine(1290, EdisonTrent, "Тяжелые истребители номадов. Они эволюционируют... дел+а плохи"),
        VoiceLine(1300, EdisonTrent, "Зерно тоже стало мощнее... Тёзка, надо ослабить зерно. Раскидай номадские истребители. Тогда зерно ослабнет и мы его разнесём"),
        VoiceLine(1310, Trent, "Сейчас сделаем"),

        VoiceLine(1320, EdisonTrent, "Зерно ослабло, его можно бить. Давай быстрее, времени не в обрез"),

        VoiceLine(1330, Trent, "Есть! Вышли!"),
        VoiceLine(1340, EdisonTrent, "Вот чёрт... кажется сегодня не мой день."),
        VoiceLine(1350, Trent, "Что стряслось?"),
        VoiceLine(1360, EdisonTrent, "Радиация зерна... А как ты смог её перенести?"),
        VoiceLine(1370, Trent, "Я не знаю... и что теперь делать"),
        VoiceLine(1380, EdisonTrent, "Так, знаешь... я передам маяк тебе. Доставь его сам, один"),
        VoiceLine(1390, Trent, "Но на моём корабле нет катапульты!"),
        VoiceLine(1400, EdisonTrent, "Знаю, знаю... чёрт..."),

        VoiceLine(1410, Mandrake, "Всем внимание! Крыг замечен в системе!"),

        VoiceLine(1420, Trent, "Тёзка, давай мне маяк. Деваться некуда, дотащу сам"),
        VoiceLine(1430, EdisonTrent, "Да, сейчас"),

        VoiceLine(1440, Trent, "Забрал, а ты тут справишься?"),
        VoiceLine(1450, EdisonTrent, "Да, всё будет хорошо. Скорее лети. Удачи там, тёзка"),
        VoiceLine(1460, Trent, "Тебе тоже..."),
