...
class Msn13Space(Msn13, script.SpaceVoiceProps):
    VOICE_LINES = [
        ...
        #
        # "Идиоты, вы сделаете только хуже!",
        # "Поздно пить Боржоми, твоим планам настал конец!",
        #
        # "Лазер ударил по Крыгу! Мы не успели!"
        # "Но вроде мы спасены? Ничего не взорвалось? Всё хорошо?"
        #
        # "Сканеры показывают активность со стороны Крыга."
        #
        # "Что происходит?"
        # "Всем срочно отойти на безопасную дистанцию!"
        #
        # "Ёлки-п+алки..."
        # "Оно жив+ое!"
        # "Всем приготовиться! Мы не знаем на что способна эта тварь!",
        #
        # "Мы потеряли Миссури нахер!",
        # "Вышлите спаситательные судна с Осириса, срочно!"
        #
        # "Генерал Кинг, Крыг еще слаб. Мы можем нейтрализовать его пока он еще не вошел в силу. Нужно уничтожить генераторы на его корпусе"
        # "Эй, вы там совсем башкой поехали с такими идеями? Я к этой штуковине не полезу!"
        # "Если мы это не сделаем, то Крыг зарядится и перебьет нас как куропаток. Выполнйте, это приказ!",
        #
        #
        ...
        #
        # 'Внимание! Крыг готовится к новому удару! Он целится в Осирис!',
        # 'Мостик, срочно усильте щиты в зоне вероятного попадания!',
        #
        # 'Осирис получил попадание! Генератор щита выведен из строя, второе такое попадание мы не выдержим!',
        # 'Команда, срочно уничтожьте генераторы! Реактор Осириса поврежден, мы не сможем быстро выйти из зоны поражения Крыга!',
        #
        # 'Фиксирую новый заряд энергии!',
        # 'Шевелитесь!',
        #
        # 'Осириус уничтожен! Нет!'
        #
        # 'Есть, Крыг потерял приток энергии! Он закрывает ядро!'
        # 'А теперь что с ним?'
        #
        # 'Мы лишили Крыга естественного притока энергии, теперь он пытается восполнить её из Сферы',
        #
        # 'Мистер Трент, нужно дестабилизировать работу энергосистемы Сферы! ',
        # 'Нужно залезть в канализационные каналы и нарушить целостность энергосетей!',
        #
        # 'Выдвигаюсь!',
        #
        # 'При виде этих дверей у самого сжимается...',
        #
        # 'Реактор Осириса вошел в норму. Приказ выйти из Сферы. Хетчер, прикрывайте Трента и следите за Крыгом',
        # 'Вас поняли, генерал Кинг',
        #
        # 'Сфера обесточена. Молодец Трент, теперь давай выбирайся из этих катакомб',
        #
        #
