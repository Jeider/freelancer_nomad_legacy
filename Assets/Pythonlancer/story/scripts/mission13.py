...
class Msn13Space(Msn13, script.SpaceVoiceProps):
    ...
    SECTOR2_NEW_PROTO = [
        ...
        "Времени мало, мы должны спешить!"
        
        "Нам нужно пробить проход в этом астероиде, чтобы через него пролететь"
        ...
        "Вы сможете промыгнуть. Направляйтесь туда"
        ...
        "Забрал, ты сам справишься?"
        "Да, всё будет хорошо. Скорее лети. Удачи, тёзка"
        "Тебе тоже..."
