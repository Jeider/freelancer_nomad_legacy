...
class Msn13Space(Msn13, script.SpaceVoiceProps):
    ...
    SECTOR3_PROTO = [
        "Класное местечко чтобы помереть. Ну зато мы спасли мир",
        "Внимание! Крыг обнаружен!",
        "В смысле? Он живой? Показывай, где он",

        "Что он делает",
        "Он использует энергию чёрной дыры, чтобы восполнить энергию",
        "Да когда уже он этой энергией нажрётся то",

        "А это что такое?",
        "Крыг использовал энергию чёрной дыры и номадские технологии, чтобы сделать непробиваемый щит и производить кочевников",
        "Что, опять эволюционировал? И что теперь делать?",
        "Мы можем усилить энергоядро и пушки корабля, собрав энергию чёрной дыры",
        "Давай попробуем",

        "А этой энергии чёрной дыры хватит Крыгу, чтобы высвободиться отсуюда?",
        "Теоретически да",
        "Вот чёрт! Кстати, а нам это под силам?",
        "Теоретически да",
        "А вот это уже звучит гораздо лучше!",

        "Мы накопили достаточно сил, чтобы уничтожить щит Крыга. Но сначала нужно уничтожить номадские нар+осты",
        "Снести эти три сиськи? Зачётно! Сейчас сделаем!",

        "Нейросеть, а что будет потом? Есть план на уничтожения Крыга?",
        "Теоретически усиленных пушек вашего корабля хватит, чтобы повредить внутренние системы крыга",
        "Номадское энергоядро подключено к устройству доктора Квентейна",
        "С помощью этого излучателя мы можем нанести сокрушительный урон по ослабленному Крыгу",
        "Мне нравится этот план",

        "Щит Крыга уничтожен. Теперь мы можем проникнуть в его чрево и повредить его внутренние системы",
        "Я честно говоря уже ничего не боюсь. Влетаем так влетаем. Разнесём эту тварь до конца",

        "Системы Крыга подавлены. Нужно покинуть его чрево",
        "Поддерживаю",
