...
class Msn6Offer(Msn6, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(40, Hatcher, ru="Отлично! Как вы уже поняли есть некий объект - Сфера. В свое время его обнаружил еще Орден, но тогда никто не смог понять что это, для чего предназначено и как работает. И про Сферу забыли. ", en="So, to recap, you both remember the immense alien artefact we call The Sphere. Originally discovered by The Order, it was one of a very few active, and by far the largest and most complex artefact ever found. Naturally, it generated immense... interest amongst the houses. Everyone tried claim a stake in it. However despite the best efforts to crack it, without a discernable control interface and a clear disinterest in attempting to communicate with humanity, it remained an inscrutable, and eventually uninteresting enigma. Left to, for want of a better term, rot."),
        VoiceLine(50, Hatcher, ru="А теперь мы узнаём что рейнландцам удалось подобрать к ней ключ и они проводят на ней свои исследования. Есть обоснованное мнение, что ничем хорошим это не закончится. Поэтому исследования эти нужно, как бы это сказать... закрыть.", en="However, thanks to Jacobo's misappropriated documents, we've learnt that the Rheinlanders are on the cusp of figuring out the technology required to to communicate with it, and are currently testing this technology as we speak. Based on his readings, Professor Mandrake believes that the Sphere is a shuttered gateway to a prison system housing hostile beings of such unimagineable power even the creators were afraid of them, and locked them away for eternity. We need your help to stop the Rhinelanders before they activate the sphere and open the portal."),
        VoiceLine(60, Trent, ru="Ха-ха-ха, отлично. Если вы не смогли подобрать к Сфере ключ сами, то никто не должен. А если подобрал, то нужно срочно устранить либо ключ, либо Сферу, либо того кто это сделал. Браво! Так не доставайся же ты никому.", en="Ha-ha-ha! Perfect. So, if you guys can't work out the key to The Sphere, then no one else can! And if someone else gets to it first, then either the key or The Sphere itself have to go. Bravo! This way no one will ever get in there."),
        ...
        VoiceLine(100, Hatcher, ru="Хорошо, с моральной подоплекой наших действий мы разобрались, теперь про материальную. Вы получите вознаграждение втрое больше обычного, и удостоверения внештатных сотрудников СБА. ", en="Very well. Now that we’re done with theory, let’s get to the practical bit. You’ll both be receiving triple the usual payment, and granted the privilege of being official partners of the ASF."),
        ...
        VoiceLine(150, Trent, ru='У меня дежавю. Вот только в прошлый раз меня называли не "мистер Трент", а "герр Трент"... С другой стороны, временами было весело... Хорошо, я в деле.', en="I'm having de-ja-vu. Only last time, I was called \"Herr Trent\", not \"Mr. Trent\"... On the other hand, I can't say it was boring. Alright, count me in."),
...
class Msn6Briefieng(Msn6, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(70, Hatcher, ru="Вы забираете артефакты, увозите их и Сфера закрывается.", en="According to Professor Mandrake, if we remove the artifacts from the scene, The Sphere will deactivate."),
        VoiceLine(80, Alaric, ru="Орден? Смутные времена?", en="The Order? \"Chaotic\" times? Schism?"),
        VoiceLine(90, Trent, ru="Позже, Аларик.", en="We'll fill you in later, Alaric. It's a lot to take in."),
        ...
        VoiceLine(120, Hatcher, ru="Хорошо, Трент. Итак, проникновение внутрь Сферы. Охраняется она беспрецедентно. Я сомневаюсь, что кайзер Рейнланда охраняется так же как она. ", en="Point taken. Ok, firstly, getting inside the complex to The Sphere isn't going to be easy. It's locked down tight - there's more security swarming over that place than the Kaiser’s palace."),
        ...
        VoiceLine(170, Hatcher, ru="Нажимаете один раз - и ваш корабль невидим, нажимаете второй раз - и он снова видим. Проблема устройства в его одноразовости. ", en="Press once to cloak. Press again and you're not."),
        VoiceLine(180, Hatcher, ru="Я не ученый, поэтому скажу просто, после выключения там что-то перегорает, и оно превращается в коробочку с горелым пластиком и обугленным  металлом. ", en="The cloak technology is still unstable, and unfortunately single-use. So after 30 minutes, or after deactivation, you're done."),
        VoiceLine(190, Trent, ru="Огнетушителями запасаться? ", en="Unstable? Does it self destruct or something? Can't you just steal the Rheinland cloaking tech?"),
        VoiceLine(200, Hatcher, ru="Нет, все безопасно, все происходит внутри устройства, даже неприятного запаха не появится. ", en="And where do you think we got our early blueprints from. You don't want to know what happens when their cloaks overheat. Don't worry, ours just melts down a little."),
        VoiceLine(210, Hatcher, ru="По времени работы. Поскольку устройство одноразовое, постарайтесь использовать его максимально эффективно. Наши головастики гарантируют тридцать минут работы. Возможно, оно проработает сорок, больше вряд ли. ", en="Before any wisecracks about hot asses, you'll barely feel the heat. The devices have advanced coolant systems that keep fire risk at a minimum."),
...
class Msn6Mount(Msn6, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(50, Trent, ru="Про нашу СУИЦИДАЛЬНУЮ миссию.", en="Yeah, the SUICIDE mission."),
        ...
        VoiceLine(80, Alaric, ru="Трент, раз уж мы подписались, надо выполнять. Давай, Трент, полетели. Обещаю, в следующий раз заказчика будешь выбирать ты.", en="Yeah. Hatcher scares me like that too. Come on, Trent, let’s just do it. Next time round I’ll let you choose the contract, I promise."),
        VoiceLine(90, Trent, ru="Если он будет, этот следующий раз. ", en="Assuming there’s be a \"next time\". I got a bad feeling about this one."),
    ]
...
class Msn6LabLand(Msn6, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, Alaric, ru="Вот мы и закроем. Хетчер решила подстраховаться. Мы уничтожим лабораторию.", en="That's the plan. But if Plan A doesn't work out... Hatcher's fallback plan is to blow up the lab."),
        VoiceLine(40, Trent, ru="Ясно.", en="Roger that."),
    ]
...
class Msn6LabRoom(Msn6, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(20, Alaric, ru="Трент, бежим! Потом рассмотришь.", en="Trent we need to skedaddle! You can ogle at it later on the video feed!!"),
    ]
...
class Msn6TorpedoAlert(Msn6, script.CutsceneProps):
    ...
    DESCRIPTION = ''
    VOICE_LINES = [
        VoiceLine(10, Hatcher, ru="Трент, у нас критическая ситуация! Рейнландцы выпустили против Миссури торпедные канонерки. ", en="Trent, we have an emergency! Rheinland gunboats have just fired a spread of torpedoes at Missouri."),
...
class Msn6OrderDeck(Msn6, script.CutsceneProps):
    ...
    DESCRIPTION = ''
    VOICE_LINES = [
        VoiceLine(10, OrderPilot, ru="Капитан Сид, мы обнаружили артефакты на борту этого фриленсера.", en="Captain Ceed, we're reading the artifacts are present and intact in the Freelancer's cargo hold."),
        VoiceLine(20, Ceed, ru="Отлично. Спасибо за работу, ребята. Артефакты – на склад, пленных – в кают-компанию.", en="Excellent work, guys. Bring the artifacts to storage. We'll take the prisoners to the brig."),
...
class Msn6Prison(Msn6, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(60, Ceed, ru="Забыл представиться. Хари Сид, капитан Ордена, лейтенант СБА, работаю тут под прикрытием.", en="Forgot to introduce meself. Harry Ceed, ASF lieutenant. Order Captain. Double agent. Spy extraordinaire."),
        VoiceLine(65, Ceed, ru="Сейчас подождем некоторое время, а потом я помогу вам покинуть негостеприимный борт Навуходоносора", en="We're just going to kick our heels up for a little while, and when the time is right I'll sneak you off the Nebuchadnezzar."),
        VoiceLine(70, DeltaThree, ru="Сдается мне, ребята, что это очередная провокация Ордена, и выведет нас этот милый капитан на шеренгу бойцов со штурмовыми винтовками.", en="Do you guys get the feeling this is just another Order ploy to put us in the line of hostile fire..."),
        VoiceLine(80, DeltaOne, ru="А у тебя что, есть предложения получше? В любом случае, лучше на шеренгу бойцов с винтовками, чем на допрос к специалистам Ордена.", en="You got a better idea? I dunno about you but I rather fancy my chances getting shot at than being interrogated by ASF goons."),
        ...
        VoiceLine(110, DeltaOne, ru=" И вы позволили?", en="Isn't ASF going to wonder how you let that happen?"),
        ...
        VoiceLine(145, Ceed, ru="А потом спокойно и небрежно проследуете в ангар к кораблю мистера Трента. ", en="Step two, follow me to Mr. Trent’s ship in the hanger. Act natural like."),
        VoiceLine(150, Ceed, ru="К сожалению, все остальные уже разбирают на запчасти. А вот корабль Трента пока еще в целости и сохранности. Так что, как говорится, в тесноте, да не в обиде.", en="Unfortunately, all your other ships have been stripped for parts. Luckily, they haven't got to Mr Trent's ship yet."),
        ...
        VoiceLine(170, Ceed, ru="О, нет. Вы же меня вырубили, этому найдутся неоспоримые доказательства. ", en="Rough me up and knock my lights out. I'll tell them you overpowered me and escaped."),
        VoiceLine(180, Ceed, ru="К тому же, что такое побег пленников в сравнении с тем, что я передал в руки  Ордена артефакты, за которыми охотится весь сектор Сириуса.", en="They're not going to divert significant resources to chase down a few escaped prisoners with those precious artefacts out in the wild."),
...
class Msn6Freeport(Msn6, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, DeltaOne, ru="Ведите себя тихо, принимайте контракты на этом фрипорте, в других независимых или пиратских системах, но ни в коем случае не возвращайтесь в легальные системы.", en="Keep a low profile. Feel free to work a few jobs here on this freeport, or any other independent stations, or hell, possibly even with the pirates. But under no circumstances return to lawful space."),
...
class Msn6Space(Msn6, script.SpaceVoiceProps):
    VOICE_LINES = [
        ...
        VoiceLine(
            ...
            en="No, we're still working out the kinks on that one. I'll drop a few containers of goodies for you, tractor them in and dock with Missouri.",
        ),
        VoiceLine(
            55,
            HatcherStation,
            ...
            en="Our military analysts have prepared special mission strategies just for you. These strategies have been uploaded to "
               "your neuralenets. You should consider using them."
        ),
        VoiceLine(
            60,
            HatcherStation,
            ru="Удачи, джентльмены. Напоминаю, на территории Рейнланда никаких радиопереговоров со мной.",
            en="Best of luck, gentlemen. And remember – strict radio silence once you reach Rheinland.",
        ),
        VoiceLine(
            70,
            Alaric,
            ru="Трент, чтобы увеличить наши шансы, предлагаю разделиться. Встречаемся внутри Сферы.",
            en="Trent, we’ll stand a better chance if we split up. I'll meet you inside the sphere.",
        ),
        VoiceLine(
            80,
            SphereOutpost,
        ...
        VoiceLine(
            ...
            en="Except the outer perimeter is locked down, so there's no way back.",
        ),
        VoiceLine(
            110,
            Alaric,
            ru="Трент, мы входим в зал в котором рейнландцы развернули лабораторию. Артефакты должны быть где-то внутри. ",
            en="Trent, we're entering the chamber where Rheinlanders have deployed their lab. The artifacts should be somewhere inside.",
        ),
        VoiceLine(
            120,
            Alaric,
            ru="Попробуй пробраться внутрь через шлюзы и найти Роттермана, а я в это время попробую снять или хотя бы ослабить щиты.",
            en="Try sneaking in through the airlocks and locate Rotterman, while I try to take down or weaken the shields.",
        ),
        VoiceLine(
            130,
            Trent,
        ...
        VoiceLine(
            ...
            en="Trent, they've overlooked a nearby maintenance vent. You should be able to get through. I'm sending you the coordinates.",
        ),
        VoiceLine(
            150,
            Trent,
        ...
        VoiceLine(
            ...
            en="ASF intel calls it the 'The Nomad Seed'. It's a gate to another dimension. If the Nomads sense your presence they'll start swarming out of it.",
            cinematic=True,
        ),
        VoiceLine(
            170,
        ...
        VoiceLine(
            ...
            en="The only problem is, if you make too much noise, our Rheinland friends will join the party. So, you have to act quickly. Destroy the Seed.",
            cinematic=True,
        ),
        VoiceLine(
            190,
        ...
        VoiceLine(
            ...
            en="Trent, hurry up! The Rheinlanders are beginning to suspect something’s up in the chamber. They about to send a group of scouts there.",
        ),
        VoiceLine(
            210,
            Trent,
        ...
        VoiceLine(
            ...
            en="Trent, what's taking you so long? Come quickly, shields are almost gone - it won't take much longer.",
        ),
        VoiceLine(
            230,
            Alaric,
        ...
        VoiceLine(
            ...
            en="Neutralize them and deliver them to Nebuchadnezzar.",
            cinematic=True,
        ),
        VoiceLine(
            410,
        ...
        VoiceLine(
            ...
            en="I know this system. This is Malta, in the Outcast territory. There's a Freeport here that welcomes allcomers, it's called Trinidad Freeport. We can wait there. Sending you the coordinates.",
        ),
        VoiceLine(
            430,
            Trent,
        ...
        VoiceLine(
            ...
            en="- deftly assassinate every soul onboard this battleship, decipher the secret coordinates to their secret base, fly over and capture it the base, and return to Manhattan glorious victors, with the artifacts held triumphantly aloft in your hands as the sun reflects off it...",
        ),
        VoiceLine(
            480,
            DeltaOne,
            ru="Как думаете, мистер Трент, ваш истребитель способен на такие боевые действия?",
            en="Mr. Trent, your thoughts?",
        ),
        VoiceLine(
            490,
            Trent,
        ...
        VoiceLine(
            ...
            en="Professor, we have a breach! The unidentified ship isn’t responding! Sound the alert!",
        ),
        VoiceLine(
            1040,
            FinnRunner,
            ru="Профессор, мой аванпост атакован неизвестным пилотом. Всеобщая тревога!",
            en="Professor, my outpost is being attacked by the unknown vessel. Alert! Alert!",
        ),
        VoiceLine(
            1050,
            FinnRunner,
        ...
        VoiceLine(
            ...
            en="Critical damage! Battleship Missouri in need of immediate assistance! To all fighter wings, intercept the torpedoes at once before they take us out!",
        ),
        VoiceLine(
            1220,
            SphereMissouri,
            ru="Канонерки израсходовали боеприпасы и покидают поле битвы. Миссури в безопасности.",
            en="The gunships have exhausted their ammo and are leaving the field. Missouri is safe.",
        ),
