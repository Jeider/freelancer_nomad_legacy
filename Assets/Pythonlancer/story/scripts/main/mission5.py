...
class Msn5Piratebar(Msn5, script.CutsceneProps):
    ...
    DESCRIPTION = ''
    VOICE_LINES = [
        VoiceLine(10, Trent, ru="Хай, бро! Есть чо? А то я тут с такого дальняка вернулся, что все мозги закисли, расслабиться бы... ", en="Hey, bro! Got some of the good stuff? Been flying in space all day long my ass has gone numb, could really use something to relax..."),
        ...
        VoiceLine(40, Trent, ru="А у меня там заначка козырная, месяц оттопыриваться можно - из омикронов привез, дельце там одно провернул.", en="Such a shame, I've got some really exotic... drugs in my hold... all the way from Omicron, and now my buyer's pulled the plug 'cos I couldn't land and deliver them personally. Bastard found another seller."),
...
class Msn5Equip(Msn5, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, Hatcher, ru="Профессор, вы лишний час просидели в капсуле из-за этого идиота Тилтона. ", en="Professor, I apologize for Tilton's keeping you an hour longer than necessary in your capsule. It must have been uncomfortable."),
        ...
        VoiceLine(390, Hatcher, ru="Нет, не конец. Служба Безопасности Альянса курирует кроме прочего и территорию Либерти, несмотря на противодействие со стороны некоторой части элиты Либерти, которая и натравливает против нас дуболомов типа Тилтона. ", en="The Alliance Security Force openly oversees Liberty but faces resistance from some of the Liberterian sub-factions. Some of these are run by douchebags like Tilton."),
        VoiceLine(400, Hatcher, ru="Но это не значит, что мы забыли свою главную функцию - защиту человечества от внешней угрозы. ", en="The new Order operates out of the shadows, officially it no longer exists. But we remain, and we remain true to our original goal – to protect humanity from extinctional level threats."),
        VoiceLine(410, Trent, ru="Как скажешь...", en="So you're an ASF agent, but also new Order..."),
        VoiceLine(420, Hatcher, ru="Трент, а можно теперь я наконец... ", en="Now, Trent, can I finally talk to the Professor in peace?"),
        VoiceLine(430, Trent, ru="Можно. ", en="Sure."),
        VoiceLine(440, Hatcher, ru="Профессор, рейнландцы откуда-то нашли информацию об Омикроне альфа... ", en="Professor, Rheinland officials managed to steal our intel on Omicron Alpha..."),
        VoiceLine(450, Mandrake, ru="И...", en="And I care because?"),
        VoiceLine(460, Hatcher, ru="Они нашли объект и ведут на нем работы.", en="They've set up camp around it and are experimenting on it now."),
        VoiceLine(470, Mandrake, ru="Рейнландцы экспериментируют со Сферой в омикроне альфа??? Вы что там, с ума посходили??? Вы чем занимаетесь??? Мистер Трент был прав... Ордену конец...", en="What? Are they out of their minds??? The fools!!! They don't know the danger! Why was the Sphere not secured? Hatcher, how could the Order have allowed this??? Mr. Trent is right... The Order really is dead..."),
        ...
        VoiceLine(510, Hatcher, ru="Ах, да, извини. Делаю перевод. Свяжусь с тобой позже.", en="Ah, yes, so sorry. I'm transferring your credits now. We'll be in touch. Professor, we have some Rheinland documents we need you to look at..."),
    ]
...
class Msn5Space(Msn5, script.SpaceVoiceProps):
    VOICE_LINES = [
        ...
        VoiceLine(
            ...
            en="Just my luck. Look, I've got a business card I just need to show someone...",
        ),
        VoiceLine(
            30,
            DetroitDispatcher,
        ...
        VoiceLine(
            ...
            en="Hmm. Back home, you could either spend money and time to get what you needed, or you save time and pay more on the black market.",
        ),
        VoiceLine(
            60,
            Trent,
        ...
        VoiceLine(
            ...
            en="That's my middle name. Ericksson Dodgy Trent. Even if it comes to nothing, at least I'm bound to have some fun.",
        ),
        VoiceLine(
            100,
            Trent,
        ...
        VoiceLine(
            ...
            en="Not again! That stupid little blabbermouthed junkie… I swear I'm going to end him one of these days.",
            cinematic=True,
        ),
        VoiceLine(
            150,
        ...
        VoiceLine(
            ...
            en="I'll take care of these gentlemen. You go and get that security pass, it's got to be in one of these warehouses.",
        ),
        VoiceLine(
            190,
            Trent,
        ...
        VoiceLine(
            ...
            en="Well, when you put it that way, how could a girl refuse?",
        ),
        VoiceLine(
            330,
            Trent,
        ...
        VoiceLine(
            ...
            en="Thanks for the offer. We've been denied clearance to dock on Clark, but we really, really need to go there.",
        ),
        VoiceLine(
            480,
            Sigma17Trader,
            ru="Окей, вставайте в формацию с нами, мы как раз везем груз на эту станцию.",
            en="Okay, get in formation with us. We're transporting cargo to Clark.",
        ),
        VoiceLine(
            490,
            Sigma17Trader,
            ru="Будем считать вас кораблями охранения, тем более что это недалеко от истины, сейчас внесу вас в ведомость.",
            en="We'll write you up as our fighter escort. I've added you to our manifest.",
        ),
        VoiceLine(
            500,
            Sigma17Trader,
        ...
        VoiceLine(
            ...
            en="I ordered laser components from Stuttgart, from our trusted suppliers. What you've delivered are strange boxes with weird markings on them. What language is this, even?",
        ),
        VoiceLine(
            560,
            Sigma17Trader,
            ...
            en="We got these crates straight from your suppliers and hauled them halfway across the galaxy to you. We don't care what you ordered. What's done is done! Pony up!",
        ),
        VoiceLine(
            570,
            ClarkResearch,
        ...
        VoiceLine(
            ...
            en="All personnel to escape pods immediately! I repeat, all personnel, ... esca...",
        ),
        VoiceLine(
            600,
            Hatcher,
        ...
        VoiceLine(
            ...
            en="We've got Mandrake! Maybe we still can save the remaining scientists!"
        ),
        VoiceLine(
            610,
            Trent,
        ...
        VoiceLine(
            ...
            en="What the... I'm a freelancer escorting these folks to Forbes, what's right do you have...",
            cinematic=True,
        ),
        VoiceLine(
            740,
