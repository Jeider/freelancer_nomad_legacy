...
class Msn4Reward(Msn4, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(80, Alaric, ru="Для вас мы всегда...", en="For you, Miss Wolf, anything..."),
...
class Msn4Final(Msn4, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, Alaric, ru="Да ладно тебе. Ты фриланесером работать стал всего ничего, и вот уже задания на уровне правительств с соответствующей оплатой.", en="Oh come now... one moment you're a newbie freelancer, the next you're raking in big bucks from international governments! Don't sell yourself short!"),
