...
class Msn4Offer(Msn4, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(65, Jacobo, ru="У меня одного это скорее всего не получится, но если вы мне поможете... ", en="I probably won't make it alone, but with you on my side..."),
        VoiceLine(67, Jacobo, ru="А если вы мне не поможете, меня скорее всего просто убьют... ", en="And if you don't help me, they'll probably just kill me..."),
        VoiceLine(70, Trent, ru="Я об этом еще пожалею... Хорошо, каков план?", en="I'm gonna regret doing that... So, what's the plan?"),
        ...
        VoiceLine(90, Trent, ru="Тогда до встречи.", en="See you there."),
    ]
...
class Msn4Reward(Msn4, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, Alaric, ru="Мисс Хетчер, у вас такие красивые бездонные глаза, что...", en="Miss Hatcher, you have such lovely, deep eyes."),
        VoiceLine(40, Hatcher, ru="Что вы перестанете нести эту околесицу, иначе я рассержусь", en="Cut this nonsense immediately, you don't want to irritate me."),
        VoiceLine(45, Hatcher, ru=". О деле. Все выполнено на лучшем уровне. ", en="Let's get to our business. You've done a fine job."),
        VoiceLine(50, Hatcher, ru="Я даже не буду спрашивать чего стоило вам сбежать из Рейнланда с ТАКИМИ документами", en="I will avoid asking how you managed to escape Rheinland with THIS kind of material."),
        VoiceLine(55, Hatcher, ru="Я девушка впечатлительная, боюсь в обморок упасть.", en="I'm a delicate lady, I'm afraid I might not be able to handle it."),
        VoiceLine(60, Trent, ru="Мы старались.", en="We did what we had to do."),
        VoiceLine(70, Hatcher, ru="Хе, вы тоже были в этом заинтересованы. А кстати, нам как раз нужны такие умелые и предприимчивые люди как вы, для выполнения, скажем так, нестандартных заданий. Вы в ближайшее время не слишком заняты?", en="Heh, seems like you had fun. And by the way, we are looking for top-notch skilled Freelancers such as yourselves to help us perform, say, some non-standard tasks. Have you got any plans for the near future?"),
        VoiceLine(80, Alaric, ru="Заткнись, Аларик. Нет, с тех пор как мы стали врагами Рейнландского государства, работы у нас поубавилось.", en="We've always got time for you..."),
        VoiceLine(90, Trent, ru="Заткнись, Аларик. Нет, с тех пор как мы стали врагами Рейнландского государства, работы у нас поубавилось.", en="Shut up, Alaric. Since we're now considered enemies of the Rheinland state, I suppose we don't have any plans yet."),
        VoiceLine(100, Hatcher, ru="То есть если у нас найдется пара заданий по вашему профилю за достойную плату...", en="So, if we have a couple of well-paid tasks that fit your field of work..."),
        VoiceLine(110, Trent, ru="То мы не против их выполнить, если конечно же эти задания не приведут к тому что мы станем государственными преступниками и в Либерти.", en="Then we won't hesitate to fulfill them. That is, unless these tasks make us enemies of the Liberty state, too."),
        VoiceLine(120, Hatcher, ru="О, нет, я думаю до этого не дойдет.", en="Oh dear, no, I don't think it'll ever come to this."),
        VoiceLine(130, Trent, ru="Я вот тоже думал...", en="Sure hope so..."),
    ]
...
class Msn4Final(Msn4, script.CutsceneProps):
    ...
    DESCRIPTION = ''
    VOICE_LINES = [
        VoiceLine(10, Alaric, ru="Круто, Трент, ты умеешь находить себе заказчиков и покровителей.", en="Awesome, Trent! Who knew you'd be so good at finding clients and closing deals?"),
        VoiceLine(20, Trent, ru="А так же врагов и убийц.", en="I'm also good at making enemies and getting close to being murdered."),
        VoiceLine(30, Alaric, ru="Да ладно тебе. Ты фриленесером работать стал всего ничего, и вот уже задания на уровне правительств с соответствующей оплатой.", en="Oh come on... You just started your freelancing career, a complete newbie, and now you're taking jobs for the government with appropriate payments!"),
        VoiceLine(40, Trent, ru="Ага, и одно из правительств уже назначило награду за мою голову, и я сомневаюсь что у этого правительства короткая память.", en="Mhm, one of those governments have already put a price on my head. And oh do I hope they forget about me soon with everything that's going on there."),
        VoiceLine(50, Alaric, ru="Да ладно тебе, с таким прикрытием рейнландцы пупок себе скорее надорвут, чем нас достанут.", en="Seriously, the Rheinland military will most likely fall apart soon. They won't bother looking for us."),
        VoiceLine(60, Trent, ru="С каким-таким прикрытием? Ну-ка Аларик, чего я не знаю?", en="You seem very confident. Come on, Alaric, what are you hiding from me?"),
        VoiceLine(70, Alaric, ru="Эта мисс Хетчер, ты в курсе кто она?", en="That Miss Hatcher, do you know who she is?"),
        VoiceLine(80, Trent, ru="Ну конечно в курсе. Я знаю её уже целых три часа, я в курсе. Аларик, короче, мать твою!", en="Well, of course I do! I've known her for a whole three hours! Screw you, Alaric."),
        VoiceLine(90, Alaric, ru="Она офицер в одной из спецслужб Либерти.", en="She's an officer in one of Liberty's secret service agencies."),
        VoiceLine(100, Trent, ru="О боже! Нет... Опять...", en="God dammit! Not again..."),
        VoiceLine(110, Alaric, ru="Ты не понимаешь, это настолько крутая спецслужба, что другие спецслужбы даже не подозревают о её существовании.", en="You don't get it. It's such a special and secret service, that not even their own counterparts in their own government know they exist."),
        VoiceLine(120, Trent, ru="Аларик, тогда ты то откуда про это знаешь?", en="Then how do you know that, Alaric?"),
        VoiceLine(130, Alaric, ru="А... Э-э-э...", en="Oh... I need to go..."),
        VoiceLine(140, Trent, ru="Короче, трындец, опять вляпался.", en="I can't believe I got into this botch again!"),
    ]
