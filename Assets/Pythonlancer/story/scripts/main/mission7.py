...
class Msn7Omega13(Msn7, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(30, Trent, ru="Рокфорд, что происходит? Ты же агент СБА, ты должен мне помочь", en="Rockford, what's going on? You told me you're ASF!"),
        VoiceLine(35, Trent, ru="Рокфорд, что происходит? Ты же агент СБА, ты должен мне помочь", en="Rockford, what's going on? You told me you're ASF!"),

        VoiceLine(40, Rockford, ru="Я не агент СБА.", en="How guillible you are, Mr Trent."),

        VoiceLine(50, Trent, ru="Ты же уничтожишь артефакты.", en="If I go down, I'm taking the artefacts with me!"),
        VoiceLine(55, Trent, ru="Ты же уничтожишь артефакты.", en="If I go down, I'm taking the artefacts with me!"),

        VoiceLine(60, Rockford, ru="Артефакты переживут уничтожение корабля.", en="Apologies. The artefacts are nigh indestructible. They will survive the explosion of your ship."),


        VoiceLine(100, Trent, ru="Да за-пус-тись же ты, ста-ро-е ко-ры-то.", en="Ah crap. Come on you old rust-bucket. Don't fail me now!"),
    ]
...
class Msn7CheckArtifact(Msn7, script.CutsceneProps):
    ...
    DESCRIPTION = ''
    VOICE_LINES = [
        VoiceLine(10, Trent, ru="Ничего себе. Похоже, у этого парня очень разносторонние интересы.", en="Wow, talk about eclectic tastes."),
        ...
        VoiceLine(40, Darcy, ru="Привет Джабба. Я хочу, чтобы ты взглянул на одну вещицу.", en="Hi, Jabba. I need you to check out something for me."),
...
class Msn7Space(Msn7, script.SpaceVoiceProps):
    VOICE_LINES = [
        VoiceLine(10, Trent, ru='Я тут каких-то гопников раскидал, но Железного Зада среди них не было.',
							 en="I blew up some bozos out here, but Iron Butt wasn't amongst them."),
        ...
        VoiceLine(35, Trent,
				  ...
				  en="That skinflint. Transfer fees probably set him back way more than 500. Next time I'm asking him \"where's the money, Lebowski?\"."),
        VoiceLine(40, RockfordStation,
				  ...
				  en="Mr. Trent, my name is Rockford. I've been sent to help you extract the artifact. I'm waiting for you at the bar on planet Malta. Come ASAP, time is of the essence."),
        VoiceLine(60, Rockford, ru='Трент, жить хочешь? Помогай!', en="It's an ambush! Take them out!"),
        ...
        VoiceLine(80, Trent, ru='Приятно познакомиться, мистер Рокфорд.', en="Can't say it's a pleasure to meet you, Mister Rockford."),
        ...
        VoiceLine(140, Trent, ru='Вообще о многом. Если вкратце, кто вы и во что я в очередной раз вляпался.',
							  en="Everything. Who are you, and what mess have I stepped into this time?"),
        ...
        VoiceLine(160, Trent,
				  ...
				  en="Oh, for fuck's sake... Alright. Then be straight with me. How did you find me? Why were they waiting for us at Malta? And what's the plan now?"),
        VoiceLine(170, Rockford,
				  ...
				  en="I made contact with Delta Lead when I reached Malta. He briefed me on the situation and informed me that your ship was the only combat-capable one left."),
        ...
        VoiceLine(190, Trent, ru='Не будем об этом. Что было дальше?', en="Let's not go there. Keep talking."),
        ...
        VoiceLine(220, Rockford,
				  ...
				  en="they could only dispatch a small team to intercept, which you and I just cleaned up. As for our next move, it's obvious. We retrieve the artefacts."),
        VoiceLine(230, Trent, ru='И у нас уже есть план?', en="And you have a plan?"),
        ...
        VoiceLine(260, Rockford,
				  ...
				  en="The artefacts are currently being held at Tortuga Base in the Omicron Minor system. It's supposedly a pirate outpost, but in actuality it belongs to the Order. It's heavily fortified."),
        ...
        VoiceLine(280, Rockford,
				  ...
				  en="If the transmitter is disabled, protocol mandates that they evacuate all high-value assets to the nearest secure facility. We will destroy the transmitter and ambush the convoy transporting the artefacts."),
        ...
        VoiceLine(310, Rockford,
				  ...
				  en=" I'm jettisoning canisters with demolition charges now. Pick them up, Trent, position them around the transmitter, and deploy them. You'll need to access your inventory and use the bin icon next to the item descriptor to deploy them."),
        VoiceLine(320, Rockford,
				  ...
				  en="You'll have to manually detonate them by shooting at them. The coordinates for the transmitter are in your computer. Move out!"),
        ...
        VoiceLine(355, Rockford, ru='Я заметил. Судя по переговорам вся станция на ушах сто+ит. Теперь посм+отрим, что они сделают.',
								 en="OK. Judging from comms chatter, the whole station is in uproar. Now, let's see what they do next."),
        ...
        VoiceLine(395, Rockford,
				  ...
				  en="Keep shooting! Its experimental shields have an Achilles heel."),
        VoiceLine(400, Rockford,
				  ...
				  en="If they cycle the guns too quickly, the generator overheats and has to reboot . It's vulnerable during the downtime. Close distance with the transport so its' turrets engage you."),
        VoiceLine(410, Trent, ru='В смысле? Быть приманкой?', en="What, and get turned into swiss cheese?"),
        VoiceLine(420, Rockford, ru='Да.', en="Yeah."),
        VoiceLine(430, Rockford, ru='Щит упал. Трент, уничтожь грузовик! Целься в уявзимые точки!', en="Shields are down! Take it out!"),
        VoiceLine(440, Rockford, ru='Они вызывают подкрепление. Скоро вся эта зона будет кишать пилотами Ордена. Уничтожь транспорт! Быстрее!',
								 en="They're calling for reinforcements. This entire sector will be swarming with Order scum in a moment. Destroy the transport! Quickly!"),
        VoiceLine(445, Rockford, ru='Транспорт взорван, подбери артефакты!', en="The transport is destroyed. Retrieve the artefacts!"),
        ...
        VoiceLine(460, Rockford,
				  ...
				  en="I have a safe house in Omega-13. We'll perform ship maintenance there and organize delivery of the artifacts to ASF High Command."),
        VoiceLine(470, Trent,
        ...
        VoiceLine(495, Rockford,
				  ...
				  en="I was an agent of the Order before the Schism. I know too much. Ever since then I've had to sleep with one eye open."),
