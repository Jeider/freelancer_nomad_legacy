...
class Msn3Offer(Msn3, script.CutsceneProps):
    ...
    VOICE_LINES = [
        ...
        VoiceLine(20, Wilham, ru="А вот и герр Трент. Познакомьтесь с герром Хасслером. В ходе этой миссии вам придется плотно сотрудничать.",
                  en="Herr Trent, please meet Herr Hassler. This mission will require both of you to work closely together."),
        ...
        VoiceLine(60, Trent, ru="А кто-то на безопасном расстоянии отсиживается. Действительно, ничего нового. А можно как-то конкретнее?",
                  en="While a certain someone will be watching safely from afar. Starting to see a pattern here. Could you be any less specific?"),
        VoiceLine(70, Wilham, ru="Можно. Наша разведка локализовала местонахождение Дитриха. Это бывшая военная база Кёнигсберг. ",
                  en="Of course not. Rhineland intelligence has managed to track down Dietrich's position. He's camping out on an old military base in Konigsberg."),
        VoiceLine(75, Wilham, ru="В данный момент собирается ударный флот для атаки базы. Но наши аналитики просчтитали, что прямое нападение на Кёнигсберг приведет к недопустимо большим потерям среди личного состава.",
                  en="We are massing a strike fleet to raid the base as we speak. However our analysts project massive losses if we were to stage a frontal assault on Konigsberg."),
        VoiceLine(77, Wilham, ru="Поэтому мы так же формируем мобильную ударную группу, задачей которой будет нейтрализация защитной системы базы к моменту подхода основных сил.",
                  en="That's why we're forming a secondary strike team, which will be tasked with neutralizing the base's defense systems just in time for our main strike fleet to sweep in and decimate it."),
        ...
        VoiceLine(90, Wilham, ru="Именно так, герр Трент. Кстати на вашем участии в этой миссии настаивал лично адмирал Райхманн.",
                  en="You are so good at guessing, Herr Trent. By the way, Admiral Reichmann himself requested you to be on the secondary strike team."),
        VoiceLine(100, Trent, ru="Весьма польщён. А можно узнать, как так оказалось, что элитная военная база с высшим классом защиты практически в самом центре территории Рейнланда осталась бесхозной и в итоге досталась мятежникам и корсарам?",
                  en="I don't know whether to be flattered or flummoxed. Could you explain to me how a super secure military base with best in class defense systems, smack in the center of Rheinland came to be abandoned and fall into the hands of Corsairs, rebels and riff-raff?"),
        ...
        VoiceLine(120, Hassler, ru="Уничтожить Кёнигсберг или разобрать её так и не дошли руки у нашего правительства, а может, надеялись на пересмотр мирного договора, с тем чтобы достроить ее и ввести в эксплуатацию, не знаю, но в итоге получилось так, что Дитрих, как один из самых высокопоставленных военных, имеющий все ключи доступа, просто-напросто её оккупировал...",
                  en="Our government in their wisdom didn't take steps to scuttle or dismantle the Konigsberg base. Perhaps they were hoping for a re-negotiation of the peace treaty, or perhaps they had some other scheme lost in history, I don't know. Eventually, Dietrich, having turned coat, and being in possession of all the access keys, just waltzed in and claimed it..."),
        VoiceLine(130, Trent, ru="Я так понимаю, спрашивать всякие глупости типа, есть ли у меня выбор, в этой ситуации неуместно.",
                  en="I'm guessing that asking whether I have a choice or not is a stupid question."),
        ...
        VoiceLine(150, Hassler, ru="Герр Трент, на вашем месте мечтали бы быть девяносто процентов местных фрилансеров. Вам платят отличные деньги, вас курирует адмирал Райхманн лично. ",
                  en="Herr Trent, ninety percent of the local freelancers could only dream of being in your shoes. Astronomical pay and reporting directly to none other than Admiral Reichmann. Something others would die for. In fact, many have."),
...
class Msn3Reward(Msn3, script.CutsceneProps):
    ...
    VOICE_LINES = [
        VoiceLine(10, Hassler, ru="Расспросил я местных, нихрена они не знают. В любом случае, спасибо, Трент, твоя работа на этом закончена, будем искать грузовик по нашим каналам. К сожалению, из-за того, что  мы с ним облажались, Райхманн значительно урезал гонорар.",
                  en="I asked the locals, they haven't reported anything. Anyways, thank you, Trent. Your work here is done, we'll be looking for the transport on our channels. Unfortunately, since we screwed up, Reichmann significantly cut your payment."),
        VoiceLine(20, Trent, ru="Странные дела. Базу уничтожили, Дитриха грохнули, а Райхманн выбесился из-за какого-то грузовика. Не нравится мне это.",
                  en="Crap. The rebel base was destroyed, Dietrich's dead, yet Reichmann freaks out and stiff me because of some puny transport. I don't like this."),
...
class Msn3Space(Msn3, script.SpaceVoiceProps):
    VOICE_LINES = [
        VoiceLine(
            ...
            en="Herr Trent, we are in need of your services again. We will discuss the details on Starke station in the Sigma-8 system. Wilham base, over.",
        ),
        VoiceLine(
            1010,
            Hassler,
            ru="Направляемся к пункту сбора. Координаты уже в вашем бортовом компьютере, герр Трент.  ",
            en="We're heading to the rendezvous point. The coordinates are already in your system, Herr Trent.",
        ),
        VoiceLine(
            1020,
            Wilham,
            ru="Я доложил Адмирал Райхманну, что мы уже в пути. Он начинает брифинг миссии.",
            en="I've informed Admiral Reichmann that we're on the way. He'll begin the mission briefing shortly.",
        ),
        VoiceLine(
            1030,
            Hassler,
        ...
        VoiceLine(
            ...
            en="I'll recap. The station's main defence is its' energy shield, divided into two hemispheres. ",
        ),
        VoiceLine(
            30,
            Reichman,
        ...
        VoiceLine(
            ...
            en="These teams will advance to their destination through an anomaly that will be activated by Herr Hassler. That is all. Let's go!",
        ),
        VoiceLine(
            1050,
            Hassler,
        ...
        VoiceLine(
            ...
            en="The station's generators have started charging the shields! Destroy the generators before they're fully charged! I repeat–our main goal is the generators!",
        ),
        VoiceLine(
            1130,
            Marauder,
        ...
        VoiceLine(
            ...
            en="There's too many of them! We can't take out the generators! Tell my family... chhhhhhhh",
        ),
        VoiceLine(
            120,
            Hassler,
            ru="Башня, говорит Каратель-1, звено Мародер полностью уничтожено. Приступаем к уничтожению генераторов нижней полусферы.",
            en="Tower, this is Punisher-1, the entire Marauder wing is down. We're diverting to destroy the lower hemisphere generators.",
        ),
        VoiceLine(
            130,
            Reichman,
        ...
        VoiceLine(
            ...
            en="Punisher, Marauder, such sexy call signs! Such a shame you are in my way. Marauder is dead. Punisher – it's your turn.",
        ),
        VoiceLine(
            150,
            Hassler,
        ...
        VoiceLine(
            ...
            en="Who is that? Is that you, Hassler? Stop serving this rotten, self-serving government! You know I'm right - come and join the people and patriots of Rheinland! I'll give you and your men a chance to surrender and join our fight, on my honour!",
        ),
        VoiceLine(
            170,
            Hassler,
            ru="Себе попробуй сохранить!",
            en="Honour? What about all the men you've already killed! I'll trade your honour for justice.",
        ),
        VoiceLine(
            180,
            Hassler,
        ...
        VoiceLine(
            ...
            en="The shield is down. Punishers, close in to the base.",
        ),
        VoiceLine(
            200,
            Trent,
        ...
        VoiceLine(
            ...
            en="Oh, hell. Tower, this is Punisher-1. Dietrich is escaping in a transport with a small fighter wing!",
        ),
        VoiceLine(
            220,
            Reichman,
        ...
        VoiceLine(
            ...
            en="Too much heat. We'll deal with it later. Stay on Dietrich and his men.",
        ),
        VoiceLine(
            1200,
            Punisher,
        ...
        VoiceLine(
            ...
            en="Dietrich and his squad are destroyed. One transport escaped.",
        ),
        VoiceLine(
            290,
            Reichman,
            ru="ХАССЛЕР, ТВОЮ МАТЬ!!! Как ты мог это допустить??? Срочно найти грузовик и уничтожить его!!!",
            en="HASSLER, YOU FOOL!!! Of all the incompetent... Find that transport and destroy it immediately!!!",
        ),
        VoiceLine(
            300,
            Hassler,
        ...
        VoiceLine(
            ...
            en="The heat signature leads to an unknown jump gate then dissipates. ",
        ),
        VoiceLine(
            1190,
            Hassler,
            ru="Летим следом. Может, еще нагоним.",
            en="Follow it in. Maybe we can still catch up with it.",
        ),
        VoiceLine(
            310,
            Trent,
            ru="Это гиперврата. Здесь столько кораблей проходит ежедневно, что мы не сможем их отследить.",
            en="That's the jump gate. There are too many ship signatures, we can't isolate the shuttle's.",
        ),
        VoiceLine(
            320,
            Hassler,
