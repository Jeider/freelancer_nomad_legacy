...
from story.gameplay.ingame_thorn import IngameThorn, GENERIC_TWO_POINT, GENERIC_MOUNTED_ROTATABLE, GENERIC_TWO_POINT_MOVE
...
class Misson11(ingame_mission.IngameMission):
    ...
    def get_save_states(self):
        return [
            ...
            SaveState(self, 'vienna_final_battle', MS('Станция Вена. Артефакты украдены Рокфордом', 'Vienna Station. Artifacts stolen by Rockford')),
        ]
